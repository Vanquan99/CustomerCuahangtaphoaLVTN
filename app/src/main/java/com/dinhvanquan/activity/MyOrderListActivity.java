...
import com.dinhvanquan.model.MyOrder;
import com.dinhvanquan.model.Productinfo;
...
import static com.dinhvanquan.utils.Utiles.isrates;
    ...
    private void setOrderList(LinearLayout lnrView, List<Productinfo> list) {
        ...
        if (list != null && !list.isEmpty()) {
            for (int i = 0; i < list.size(); i++) {
                ...
                txtqtr.setText(" Qty :" + list.get(i).getProductQty());
